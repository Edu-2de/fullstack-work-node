...
export class CreateUserTable1775864279029 implements MigrationInterface {
    name = 'CreateUserTable1775864279029'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('organizer', 'customer', 'ghost')`);
        ...
        await queryRunner.query(`CREATE TABLE "events" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "description" character varying NOT NULL, "start_date" TIMESTAMP(3) NOT NULL, "location" character varying NOT NULL, "total_capacity" integer NOT NULL, "available_capacity" integer NOT NULL, "price" integer NOT NULL, "banner_url" character varying, "organizerId" uuid, CONSTRAINT "PK_40731c7151fe4be3116e45ddf73" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."tickets_status_enum" AS ENUM('valid', 'cancelled', 'used')`);
        await queryRunner.query(`CREATE TABLE "tickets" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "purchase_date" TIMESTAMP(2) NOT NULL, "status" "public"."tickets_status_enum" NOT NULL DEFAULT 'valid', "eventsId" uuid, "customerId" uuid, CONSTRAINT "PK_343bc942ae261cf7a1377f48fd0" PRIMARY KEY ("id"))`);
